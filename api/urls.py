...
posts_router = routers.NestedDefaultRouter(router, r"job-posts", lookup="job_post")
...
urlpatterns = [
    ...
    path('applications/<str:job_app_pk>/reviews/<str:review_pk>', JobApplicationReviewView.as_view(), name='application-review'),
